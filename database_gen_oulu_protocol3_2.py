...
def get_dataset(paths,filename): #this function get the dataset from the given path
    ...
    if database[-1] in {'Train_2.txt'} and st_file_path[-1] in {'train_2'} :
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Train_files/')

    if database[-1] in {'Dev_2.txt'} and st_file_path[-1] in {'dev_2'}:
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Dev_files/')

    if database[-1] in {'Test_2.txt'} and st_file_path[-1] in {'test_2'}:
...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Train_2.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Dev_2.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Test_2.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/train_2') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/dev_2')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/test_2')
