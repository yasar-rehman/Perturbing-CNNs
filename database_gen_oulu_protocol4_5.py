...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Train_5.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Dev_5.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Test_5.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/train_5') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/dev_5')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/test_5')
