...
def get_dataset(paths,filename): #this function get the dataset from the given path
    ...
    if database[-1] in {'Train_5.txt'} and st_file_path[-1] in {'train_5'} :
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Train_files/')

    if database[-1] in {'Dev_5.txt'} and st_file_path[-1] in {'dev_5'}:
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Dev_files/')

    if database[-1] in {'Test_5.txt'} and st_file_path[-1] in {'test_5'}:
...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Train_5.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Dev_5.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Test_5.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/train_5') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/dev_5')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/test_5')
