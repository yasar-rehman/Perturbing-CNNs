...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Train_3.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Dev_3.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Test_3.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/train_3') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/dev_3')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/test_3')
