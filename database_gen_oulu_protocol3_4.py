...
def get_dataset(paths,filename): #this function get the dataset from the given path
    ...
    if database[-1] in {'Train_4.txt'} and st_file_path[-1] in {'train_4'} :
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Train_files/')

    if database[-1] in {'Dev_4.txt'} and st_file_path[-1] in {'dev_4'}:
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Dev_files/')

    if database[-1] in {'Test_4.txt'} and st_file_path[-1] in {'test_4'}:
...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Train_4.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Dev_4.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Test_4.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/train_4') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/dev_4')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/test_4')
...
#
#
parent_path = '~/Documents/Newwork/OULU_FACE_Protocol3'
# #
child_path1 = 'train_4'
child_path2 = 'dev_4'
child_path3 = 'test_4'
# #
textfile1 = '~/Documents/Newwork/OULU_FACE_Protocol3'
# #
...
for i in range(len(pair_filename)-2):
