...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Train_4.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Dev_4.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Test_4.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/train_4') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/dev_4')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/test_4')
