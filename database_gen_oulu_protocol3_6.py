...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Train_6.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Dev_6.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Test_6.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/train_6') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/dev_6')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/test_6')
