...
# include some of the background area within the frame. After while, we either store that into a separate directory
...
def get_dataset(paths,filename): #this function get the dataset from the given path
    ...
    if database[-1] in {'Train_6.txt'} and st_file_path[-1] in {'train_6'} :
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Train_files/')

    if database[-1] in {'Dev_6.txt'} and st_file_path[-1] in {'dev_6'}:
        database_path = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Dev_files/')

    if database[-1] in {'Test_6.txt'} and st_file_path[-1] in {'test_6'}:
...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Train_6.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Dev_6.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_4/Test_6.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/train_6') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/dev_6')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol4/test_6')
