...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_2/Train.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_2/Dev.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_2/Test.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol2/train') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol2/dev')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol2/test')
...
#
#
parent_path = '~/Documents/Newwork/OULU_FACE_Protocol2'
# #
child_path1 = 'train'
child_path2 = 'dev'
child_path3 = 'test'
# #
textfile1 = '~/Documents/Newwork/OULU_FACE_Protocol2'
# #
