...
path1 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Train_1.txt')
path2 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Dev_1.txt')
path3 = os.path.expanduser('~/Documents/Newwork/OULU_NPU/Protocols/Protocol_3/Test_1.txt')



# first make a list of train and test text files to store the corresponding paths and labels

train_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/train_1') # file path for training
dev_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/dev_1')
test_filepath = os.path.expanduser('~/Documents/Newwork/OULU_protocol3/test_1')
